  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/3.jpg" width=100 height=100 alt="Mohammed Sarhan" class="img-rounded">
		 </div>
		 <div class="col-md-5">
     <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Mohammed Sarhan</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+201557550635</h4>
		<h4 style="font-family:'typo' ">sarhanmuhammad584@gmail.com</h4>
		<h4 style="font-family:'typo' ">Egypt , New Damietta</h4></div></div>
		</p>
      </div>
